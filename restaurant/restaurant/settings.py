...
SESSION_COOKIE_SECURE=False #https only for secure website
SESSION_COOKIE_SAMESITE='Lax' #malicious attack, block crosssite request block, to security samesite 
